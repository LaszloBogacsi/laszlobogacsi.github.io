...
keywords = [
  ...
  # Professional Roles & Soft Skills
...
<div style="display: flex; flex-direction: column; align-items: center;">
    {{< qr text="https://linkedin.com/in/laszlo-bogacsi" alt="QR code leading to author's LinkedIn profile page" title="Laszlo's LinkedIn Profile" />}}
    <span style="font-style:italic;">LinkedIn Profile</span>
</div>
...
Languages & Frameworks: Kotlin, Java 8, JavaScript, TypeScript, React, .NET MVC, Dropwizard
Infrastructure & Observability: AWS Lambda, API Gateway, EC2, S3, RDS, DynamoDB, CloudFormation, Step Functions, CircleCI, RabbitMQ, AppDynamics, New Relic, Kibana (ELK)
...
Languages & Frameworks: Java 8, Vert.x, AngularJS, Angular 5
Infrastructure & Observability: Aerospike, internal monitoring tooling (light DevOps involvement)
